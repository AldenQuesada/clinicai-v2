-- ============================================================================
-- DOWN · migration 200 · reverte o Encerrar operacional (kpi_cleared_at).
-- 1) Restaura a view à definição da mig 199 (effective-reply, SEM kpi_cleared_at).
-- 2) Remove a coluna kpi_cleared_at.
-- Nota: em prod, se houver dado operacional em kpi_cleared_at que se queira
--   preservar, rodar só o CREATE OR REPLACE VIEW e manter a coluna órfã.
-- ============================================================================
...
-- remove a coluna (seguro: a view restaurada não a referencia)
ALTER TABLE public.wa_conversations DROP COLUMN IF EXISTS kpi_cleared_at;
