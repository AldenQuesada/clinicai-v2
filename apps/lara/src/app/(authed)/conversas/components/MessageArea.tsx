...
export function MessageArea({
  ...
  // Sprint 1 · DoctorAnswerCard tem polling proprio 15s · descobre resposta nova sozinho
  ...
  return (
    <div className="flex-1 flex flex-col bg-[hsl(var(--chat-bg))] relative h-full min-w-0">
      ...
      {/* Sprint 1 · AskDoctorModal lifted pra page (/secretaria) ·
          permite trigger via botao no painel direito (LeadInfoPanel) */}
    </div>
  );
}
