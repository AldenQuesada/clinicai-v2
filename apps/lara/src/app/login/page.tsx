 ...
 * Apos login, redireciona pra ?redirect=<path> ou /conversas (default).
 *
...
export default async function LoginPage({ searchParams }: PageProps) {
  ...
  const redirectTo = params.redirect || '/conversas'
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-light leading-tight">
            <span className="font-cursive-italic text-[var(--color-champagne)]">Lara</span>
          </h1>
          <p className="text-sm text-[var(--color-text-muted)] mt-2">
            Painel de conversas com pacientes
          </p>
        </div>
